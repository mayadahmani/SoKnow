...
class VueAgenda extends Vue {
    ...
    protected $titre = "My Calendar - SoKnow";
            ...
            <div class="card agenda-modal-box" style="width: 100%; max-width: 600px; padding: 30px;">
                ...
                <form method="POST" action="index.php?page=agenda&action=create">
                    <div style="margin-bottom: 16px;">
                        <label style="font-size: 12px; font-weight: 700; color: #4B5563; text-transform: uppercase;">Titre</label>
                        <input type="text" name="title" required class="input-textarea" style="min-height: 40px; margin-top: 6px;" placeholder="Titre de l'événement">
                    </div>
                    <div style="margin-bottom: 16px;">
                    ...
                    <div id="user_select_div" style="display:none; margin-bottom: 24px;">
                        ...
                        <select name="invited_users[]" multiple class="input-textarea" style="margin-top: 6px; height: 100px;">
                            <?php foreach ($allUsers as $u): ?>
                                <option value="<?= htmlspecialchars($u['id']) ?>"><?= htmlspecialchars($u['first_name'] . ' ' . $u['last_name']) ?> (<?= htmlspecialchars($u['role']) ?>)</option>
                            <?php endforeach; ?>
                        </select>
